...
---
Setting variables and meta data
```
```{r}
...
Reading the data, naming varibles (activities) and combining the sets together
```
```{r}
...
Now we extract the mean and STD data
...
Naming the variables and creating tidy dataset
